...
public class itemAmethystLeggings extends ItemArmor {
	public itemAmethystLeggings(int par1, EnumArmorMaterial par2EnumArmorMaterial,
			int par3, int par4) {
			super(par1, par2EnumArmorMaterial, par3, par4);
			this.setUnlocalizedName("itemAmethystLeggings");
		...
		public void registerIcons(IconRegister IR) {
				itemIcon = IR.registerIcon("Testing:itemAmethystLeggings");
			}
}