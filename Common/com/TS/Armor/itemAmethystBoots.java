...
public class itemAmethystBoots extends ItemArmor {
	public itemAmethystBoots(int par1, EnumArmorMaterial par2EnumArmorMaterial,
			int par3, int par4) {
			super(par1, par2EnumArmorMaterial, par3, par4);
			this.setUnlocalizedName("itemAmethystBoots");
			...
			public void registerIcons(IconRegister IR) {
				itemIcon = IR.registerIcon("Testing:itemAmethystBoots");
			}
}